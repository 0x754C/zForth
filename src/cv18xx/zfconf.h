...
#include <stdint.h>
typedef int64_t zf_cell;
#define ZF_CELL_FMT "%lld"
#define ZF_SCAN_FMT "%lld"
...
typedef int64_t zf_int; // riscv64's int width is 32bit, but register width is 64bit, so we use int64_t instead int
